...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-phantomas/node_modules/phantomas/lib/metadata/generate.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-phantomas/node_modules/phantomas/lib/metadata/generate.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-phantomas/node_modules/phantomas/lib/metadata/</a> &#187; generate.js</div>
</div>
<div class="body">
...
&nbsp;
		if (typeof data.metrics[metricName] !== 'undefined') {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (hasDesc) {
<span class="cstat-no" title="statement not covered" >				debug('Found duplicated definition of %s metric in %s module', metricName, moduleName);</span>
			}
			continue;
		}
&nbsp;
		// parse @desc
		<span class="missing-if-branch" title="else path not taken" >E</span>if (hasDesc) {
...
<span class="cstat-no" title="statement not covered" >			debug('Metadata missing for %s metric in %s module', metricName, moduleName);</span>
		}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		debug('Storing failed: %s', err);</span>
	} else {
		debug('Done');
	}
});
